...
class BasketballTest(PluginTest):
    ...
    def setUp(self):
        ...
        if m.get_data("API_KEY") is None:
            ...
            self.headers = {
                ...
                "x-rapidapi-key": m.get_data("API_KEY"),
            }
    ...
    def test_todays_games(self):
        ...
        with patch.object(requests, "get", headers=self.headers) as get_mock:
            ...
            get_mock.assert_called_with(
                "https://api-basketball.p.rapidapi.com/games?date={}".format(date),
    ...
    def test_search_team(self):
        ...
        with patch.object(requests, "get", headers=self.headers) as get_mock:
            ...
            get_mock.assert_called_with(
                "https://api-basketball.p.rapidapi.com/teams?search=boston",
                headers=self.headers,
            )
    ...
    def test_search_league(self):
        ...
        with patch.object(requests, "get", headers=self.headers) as get_mock:
            ...
            get_mock.assert_called_with(
                "https://api-basketball.p.rapidapi.com/leagues?search=nba",
                headers=self.headers,
            )
