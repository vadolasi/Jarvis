...
class MyResponse(requests.models.Response):
    text = json.dumps(
        {
            "city": {"country": "GB", "name": "London"},
            "list": [
                {"temp": {"min": 11.00, "max": 21.00}, "weather": [{"main": "Clear"}]},
                {"temp": {"min": 17.00, "max": 27.00}, "weather": [{"main": "Rain"}]},
            ],
            "cnt": 2,
        }
    )
