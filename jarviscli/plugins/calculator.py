...
class Calculator:
    ...
    def __call__(self, jarvis, s):
        ...
        self.buffer = tk.Label(
            self.calcwin, bg="yellow", width=27, fg="red", anchor="w", font=("", 13)
        )
        ...
        self.equalbtn = tk.Button(
            self.calcwin, text="=", font=("Elephant", 20), command=lambda: self.equal(0)
        )
