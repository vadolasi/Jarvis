...
def enable_sound(jarvis, s):
    ...
    jarvis.say(
        Fore.BLUE
        + "Jarvis uses Googles speech engine.\nDo you consent with data "
        + "collection when Jarvis talks out loud? If yes, type:"
        + Fore.RED
        + " gtts"
    )
    jarvis.say(
        Fore.BLUE
        + "If not, Jarvis will talk using the built-in speech engine. "
        + " If you wish to disable GTTS, type: "
        + Fore.RED
        + "disable gtts"
    )
