...
def move(
    hand, suit, cards, suits, bet
):  # Here, hand is a nested list inside a list. It is a list of all hands of a player.
        ...
        if choice in ["H", "h"]:
            ...
            if hand[0][0] == hand[0][1]:
                if not hand[0][0] == 1:
                    ...
                    print(
                        "Newcard for first split is", str(newcard1) + " of " + newsuit1
                    )
                    newcard2 = random.choice(cards)
                    newsuit2 = random.choice(suits)
                    print(
                        "Newcard for second split is", str(newcard2) + " of " + newsuit2
                    )
                    ...
                    print(
                        "Split hands are",
                        pprinthand(splitHand1[0], splitSuit1[0]),
                        ", ",
...
def blackjack(jarvis, s):
    ...
    while choice in "Yy":
        ...
        jarvis.say(
            "Dealer hand: "
            + pprinthand(dealerhand, dealersuit, type="partially-visible"),
            Fore.MAGENTA,
        )
        delay()
        jarvis.say("---------------------------")
        ...
        player["hands"], player["suits"], player["bets"] = move(
            player["hands"], player["suits"], cards, suits, player["bets"]
        )
        jarvis.say("Your hands and respective bets for this round are:", Fore.BLUE)
        jarvis.say(
            pprinthandlist(player["hands"], player["suits"])
            + "      "
            + str(player["bets"]),
            Fore.BLUE,
        )
        ...
        while dealersum < 17 or (
            dealersum == 17 and 11 in dealerhand
        ):  # condition which determines if dealer hits or not.
            ...
            jarvis.say(
                "Newcard is " + str(dealerhand[-1]) + " of " + str(dealersuit[-1]),
                Fore.MAGENTA,
            )
            dealersum, dealerhand = blackjacksum(dealerhand)
            jarvis.say("Dealer's sum is " + str(dealersum), Fore.MAGENTA)
            jarvis.say(
                "Dealer's hand is " + pprinthand(dealerhand, dealersuit), Fore.MAGENTA
            )
        delay()
        jarvis.say("---------------------------")
        ...
        for j in range(len(player["hands"])):
            ...
            dealersum, dealerhand = blackjacksum(dealerhand)
            jarvis.say(
                "For the hand- " + pprinthand(hand, suit) + "  sum is-" + str(sum_),
                Fore.BLUE,
            )
