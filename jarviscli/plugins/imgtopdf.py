    ...
    def imgtopdf(self, jarvis):
        ...
        while True:
            ...
            # For single image to be converted to pdf
                ...
                while True:
                    ...
                    if os.path.exists(image_path) and (
                        image_path.endswith(".jpg") or image_path.endswith(".png")
                    ):
                        break
                    else:
                        jarvis.say(
                            "Opps! Looks like you entered an invalid path. Kindly Re-enter",
                            Fore.RED,
                        )
            ...
            # For multiple images in a folder to be converted to pdf
                ...
                while True:
                    folder_path = jarvis.input("Enter the full path of the folder: ")
