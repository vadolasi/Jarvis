...
def pushups(jarvis, s):
    ...
    if maximum < 15:
        jarvis.say(
            "Firstly, try to reach your maximum to at least 15, then call me again!",
            Fore.BLUE,
        )
        quit(jarvis)
        return
    ...
    if s == "'q'" or s == "q":
        ...
        for i in range(1, 6):
            notify(
                "Start Set " + str(i),
                "Do " + str(num + 3 - i) + " pushups",
                urgency=NOTIFY_NORMAL,
            )
            jarvis.say(
                "Start Set " + str(i) + " - Do " + str(num + 3 - i) + " pushups",
                Fore.BLUE,
            )
...
def pullups(jarvis, s):
    ...
    if maximum < 7:
        jarvis.say(
            "Firstly, try to reach your maximum to at least 7, then call me again!",
            Fore.BLUE,
        )
        quit(jarvis)
        return
    ...
    if s == "'q'" or s == "q":
        ...
        for i in range(1, 6):
            ...
            notify(
                "Start Set " + str(i),
                "Do " + str(num + 3 - i) + " pullups",
                urgency=NOTIFY_NORMAL,
            )
            jarvis.say(
                "Start Set " + str(i) + " - Do " + str(num + 3 - i) + " pullups",
                Fore.BLUE,
            )
            jarvis.input("Press enter after finishing", Fore.GREEN)
            jarvis.say("Rest: " + str(rest) + " sec...", Fore.BLUE)
