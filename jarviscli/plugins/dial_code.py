...
@alias("phone code of", "dialing code of")
@plugin("dial code of")
class DialCode:
    """
    ...
    def __call__(self, jarvis, s):
        ...
        if code:
            ...
            jarvis.say(
                Fore.RED + "Can't find code for country " + Fore.WHITE + "'" + s + "'"
            )
            choice = jarvis.input(
                Fore.GREEN + "Print avaliable countries?" + Fore.WHITE + " (y/N): "
            )

            if choice in ["y", "Y"]:
                # Open the file with dial codes
                codes_file = open(
                    os.path.join(FILE_PATH, "../data/dial_codes.json"), "r"
                )
    ...
    def handle_input(self, country):
        ...
        # Open the file with dial codes
        codes_file = open(os.path.join(FILE_PATH, "../data/dial_codes.json"), "r")
...
class CountryByhDC:
    ...
    def __call__(self, jarvis, s):
        ...
        if countries:
            ...
            jarvis.say(
                Fore.RED + "Can't find country with code " + Fore.WHITE + "'" + s + "'"
            )
