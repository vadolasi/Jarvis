    ...
    def get_stock_id(self, jarvis, name):
        ...
        if resp.status_code == 200:
            ...
            try:
                ...
                jarvis.say(
                    "The endpoint is not working at the moment. Try again later",
                    Fore.RED,
                )
        else:
    ...
    def get_profile(self, jarvis, symbol):
        ...
        if resp.status_code == 200:
            ...
            if not data:
                ...
                jarvis.say(
                    " Company     : " + data["profile"]["companyName"], Fore.GREEN
                )
                ...
                jarvis.say(
                    " Description : " + data["profile"]["description"], Fore.GREEN
                )
        ...
        if resp.status_code == 200:
            ...
            if not data:
                ...
                for gainer in data["mostGainerStock"]:
                    jarvis.say(
                        gainer["ticker"] + " | " + gainer["companyName"], Fore.GREEN
                    )
                    jarvis.say(
                        "Price: "
                        + str(gainer["price"])
                    ...
                    jarvis.say(
                        "Percent gained: "
                        + str(gainer["changesPercentage"])[1:-1]
                        + "\n\n",
                        Fore.GREEN,
                    )
        else:
        ...
        if resp.status_code == 200:
            ...
            if not data:
                ...
                for loser in data["mostLoserStock"]:
                    jarvis.say(
                        loser["ticker"] + " | " + loser["companyName"], Fore.GREEN
                    )
                    jarvis.say(
                        "Price: "
                        + str(loser["price"])
                    ...
                    jarvis.say(
                        "Percent lost: "
                        + str(loser["changesPercentage"])[1:-1]
                        + "\n\n",
                        Fore.GREEN,
                    )
        else:
