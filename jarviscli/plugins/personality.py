...
def read_questions():
    Q = []
    with open(os.path.join(FILE_PATH, "../data/personality_questions.tsv")) as f:
...
class personality_test:
    ...
    def __init__(self):
        ...
        self.instruction = (
            ...
            + "3 if you are in the middle, etc."
            + Style.RESET_ALL
        )

        self.types = ["IE", "SN", "FT", "JP"]
        self.scoring_scheme = (
            (30, (15, 23, 27), (3, 7, 11, 19, 31)),
    ...
    def __call__(self, jarvis, s):
        ...
        prompt_formatter = {"cyan": Fore.CYAN, "black": Fore.BLACK, "green": Fore.GREEN}
        ...
        jarvis.say(
            "{}Your personality is: {}{}{}{}".format(
                Fore.BLUE, Fore.BLACK, Back.MAGENTA, self.type, Style.RESET_ALL
            )
        )
        jarvis.say(
